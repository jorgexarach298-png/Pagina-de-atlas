 ...
 * `admin: true` da permisos de administración sin dejar de ser jugador.
 */
const SEED_PLAYERS = [
  { number: '15', username: 'Cristian-15m-8', position: 'POR' },
  ...
  { number: '56', username: 'BLK_Nebula', position: 'DFC', alias: 'Nebulosa' },
  { number: '4', username: 'danico_21', position: 'DFC' },

  { number: '19', username: 'Franmp0004', position: 'LI' },
  { number: '23', username: 'Angelotss', position: 'LD', admin: true },
  { number: '29', username: 'RodriKTV', position: 'LD', admin: true },

  { number: '8', username: 'habixuelo75', position: 'MC', admin: true },
  { number: '10', username: 'DRKSNP-RiverYT', position: 'MC' },
  { number: '22', username: 'racknaroock', position: 'MC' },
  { number: '17', username: 'RAyNext77', position: 'MC' },

  { number: '7', username: 'antoniogarciagal', position: 'DC', admin: true },
...
function createSeedDatabase() {
  ...
  return {
    ...
    club: {
      ...
      admins: players.filter((p) => p.isAdmin).map((p) => p.username),
    },
    players,
    lineup: {
...
function countEntries(entries) {
  ...
  const rosterSize = database.players.length;
