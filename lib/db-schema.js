...
-- Ayudas y pruebas: gente de fuera que completa el once en la pizarra. No son
-- miembros de la plantilla ni tienen cuenta, pero ocupan una ficha igual que
-- ellos. Se guardan en la misma tabla para que las claves ajenas del once, las
-- estadísticas y las papeletas sigan funcionando, y se distinguen con is_guest:
-- quedan fuera de la plantilla, del check-in, de las cartas y de las notas.
